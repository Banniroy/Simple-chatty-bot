...
function test() {
    ...
    const a = console.log("1. To repeat a statement multiple times.")
    const b = console.log("2. To decompose a program into several small subroutines.")
    const c = console.log("3. To determine the execution time of a program.")
    const d = console.log("4. To interrupt the execution of a program.")
    const enter = input();
    if (enter === b){
       end();
    }else{
